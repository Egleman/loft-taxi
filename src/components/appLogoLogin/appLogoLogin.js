    ...
    return (
        <div className='logo'>
            <svg width="136" height="136" viewBox="0 0 136 136" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M22.4143 22.5858L30.8285 31" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M40.4143 109L32.0001 117.414" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M55.4143 93L47.0001 101.414" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M70.4143 77L62.0001 85.4142" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M100.414 45L92.0001 53.4142" stroke="#FDBF5A" strokeWidth="4"/>
                ...
                <path d="M85.4141 61L76.9998 69.4142" stroke="#FDBF5A" strokeWidth="4"/>
            </svg>
            <p>loft<span>taxi</span></p>
        </div>
    )
}
export default AppLogoLogin;